//Given a directed, weighted graph where all edges are non-negative, write a program to find the shortest path distance and the path itself for all nodes from the source s
